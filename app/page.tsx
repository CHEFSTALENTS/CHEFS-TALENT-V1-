    ...
    <div className="bg-[#f4efe8] text-[#161616]">
      ...
      <section className="relative h-[90vh] min-h-[680px] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full items-end px-6 pb-14 md:px-12 md:pb-16 lg:px-20 lg:pb-20">
          ...
          >
            <p className="mb-5 text-[10px] uppercase tracking-[0.35em] text-white/78 md:mb-6">
              Chefs Talents
            </p>
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                href="/conciergeries"
                className="inline-flex min-h-[56px] w-full items-center justify-center rounded-full border border-white/40 bg-black/10 px-8 text-sm font-medium text-white transition hover:bg-white/10 sm:w-auto"
              >
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {[
              ...
              >
                <p className="font-serif text-[2.8rem] leading-none text-white md:text-5xl">
                  {stat.value}
                </p>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-12">
            <div className="lg:col-span-4">
              ...
              <Link
                href="/destinations"
                className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-[#161616] underline underline-offset-4 hover:opacity-70 transition"
              >
            ...
            <div className="lg:col-span-8">
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
                {DESTINATIONS_FEATURED.map((dest, i) => (
                  ...
                  >
                    <Link
                      href={`/destinations/chef-prive-${dest.name
                        .toLowerCase()
                        .normalize('NFD')
                        .replace(/[\u0300-\u036f]/g, '')
                        .replace(/\s+/g, '-')
                    ...
                    >
                      ...
                      <p className="text-[14px] font-medium text-[#161616] group-hover:text-[#3f3a34]">
                        {dest.name}
                      </p>
          ...
          <div className="grid gap-10 lg:grid-cols-12">
            ...
            <div className="lg:col-span-8">
              <p className="max-w-[24rem] text-[18px] font-light leading-8 text-[#59544d] md:max-w-3xl md:text-xl md:leading-relaxed">
                Nos 400 chefs sont sélectionnés selon leur expérience, leur mobilité, leur capacité
      ...
      {/* ── SÉLECTION — 1 seule carte simplifiée ──────────── */}
          ...
          <div className="rounded-[32px] bg-[#161616] px-8 py-12 md:px-14 md:py-16 lg:grid lg:grid-cols-12 lg:gap-10 lg:items-center">
            ...
            <div className="lg:col-span-7 grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-[24px] border border-white/20 bg-white/10 px-6 py-8">
                ...
                <p className="text-[15px] font-light leading-7 text-white/70">
                  Un accès dédié aux profils validés pour des missions complexes, longue durée ou récurrentes.
                </p>
                <Link
                  href="/conciergeries"
                  className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-white/80 hover:text-white transition"
      ...
      <section className="px-6 py-24 md:px-10 lg:px-16">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-6 text-[18px] font-light leading-8 text-[#59544d] md:text-lg">
          ...
          <div className="mt-12 border-t border-[#d8d1c7]">
            <FaqItem
              ...
              content="Nous analysons votre brief (lieu, dates, attentes, budget), puis nous revenons vers vous avec une sélection de chefs disponibles et pertinents dans les 6 heures. Vous validez un profil, et nous coordonnons ensuite l'ensemble de la mission."
              isDefaultOpen
            />
            <FaqItem
            ...
            <FaqItem
              ...
              content="Absolument. La discrétion est un principe fondamental de Chefs Talents. Les lieux, clients et détails des missions ne sont jamais rendus publics."
            />
          </div>
