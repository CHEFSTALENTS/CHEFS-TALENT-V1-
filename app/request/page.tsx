...
const T = {
  fr: {
    ...
    s7sub: "Indicatif — nous vous envoyons un devis personnalisé sous 6 à 24h.",
    ...
    s10sub: "Thomas, votre interlocuteur, vous recontacte sous 6 à 24h avec une sélection ciblée.",
...
s10nccRequired: "Veuillez accepter les conditions de confidentialité.",
    ...
    successSub: "Des chefs sont prêts à opérer. Thomas, votre interlocuteur, vous recontacte sous 6 à 24h avec une sélection ciblée.",
    successRef: "Réf.",
  ...
  en: {
    brand: "CHEFS TALENTS",
    tagline1: "Reply within 6 to 24h",
    ...
    s7sub: "Indicative — we send you a personalised quote within 6 to 24h.",
    ...
    s10sub: "Thomas, your contact, will get back to you within 6 to 24 hours with a curated selection.",
...
s10nccRequired: "Please accept the confidentiality terms to continue.",
    ...
    successSub: "Chefs are ready to operate. Thomas, your contact, will get back to you within 6 to 24 hours with a curated selection.",
    successRef: "Ref.",
  ...
  es: {
    ...
    s7sub: "Indicativo — le enviamos un presupuesto personalizado en 6 a 24h.",
    ...
    s10title: "Casi listo.",
    s10sub: "Thomas, su contacto, le responderá en 6 a 24 horas con una selección curada.",
...
s10nccRequired: "Por favor acepte los términos de confidencialidad.",
    ...
    successSub: "Hay chefs listos para operar. Thomas, su contacto, le responderá en 6 a 24 horas con una selección curada.",
    successRef: "Ref.",
...
const DESTINATIONS = [
  // ── CÔTE D'AZUR ─────────────────────────────────────────
  { name: "Saint-Tropez", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Cannes", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Monaco", country: "Monaco", flag: "🇲🇨", tier: "exclusive" },
  { name: "Cap Ferrat", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Antibes", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Juan-les-Pins", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Nice", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Èze", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Menton", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Villefranche-sur-Mer", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Beaulieu-sur-Mer", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Ramatuelle", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Gassin", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Port Grimaud", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Cogolin", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Sainte-Maxime", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Fréjus", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Saint-Raphaël", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Mandelieu", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Théoule-sur-Mer", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "La Napoule", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Mougins", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Valbonne", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Grasse", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Côte d'Azur", country: "France", flag: "🇫🇷", tier: "premium" },

  // ── ATLANTIQUE & SUD-OUEST ──────────────────────────────
  { name: "Cap Ferret", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Arcachon", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Pyla-sur-Mer", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "La Teste-de-Buch", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Lège-Cap-Ferret", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Biarritz", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Saint-Jean-de-Luz", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Anglet", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Hendaye", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Hossegor", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Capbreton", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Soulac-sur-Mer", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Biscarrosse", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Mimizan", country: "France", flag: "🇫🇷", tier: "standard" },

  // ── BRETAGNE & NORMANDIE ────────────────────────────────
  { name: "Saint-Malo", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Dinard", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "La Baule", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Deauville", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Trouville", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Honfleur", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Cabourg", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Étretat", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Belle-Île-en-Mer", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Île de Ré", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Île d'Oléron", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Noirmoutier", country: "France", flag: "🇫🇷", tier: "standard" },

  // ── ALPES ───────────────────────────────────────────────
  { name: "Courchevel", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Megève", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Val d'Isère", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Méribel", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Les Arcs", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "La Plagne", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Tignes", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Verbier", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Gstaad", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Zermatt", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Saint-Moritz", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Chamonix", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Les Gets", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Morzine", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Avoriaz", country: "France", flag: "🇫🇷", tier: "standard" },

  // ── PROVENCE & CORSE ────────────────────────────────────
  { name: "Aix-en-Provence", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Luberon", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Gordes", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Bonnieux", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Ménerbes", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Lourmarin", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Les Baux-de-Provence", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Saint-Rémy-de-Provence", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Porto-Vecchio", country: "France", flag: "🇫🇷", tier: "exclusive" },
  { name: "Bonifacio", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Calvi", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Saint-Florent", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "Ajaccio", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Marseille", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Cassis", country: "France", flag: "🇫🇷", tier: "premium" },
  { name: "La Ciotat", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Bandol", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Toulon", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Hyères", country: "France", flag: "🇫🇷", tier: "standard" },
  { name: "Porquerolles", country: "France", flag: "🇫🇷", tier: "premium" },

  // ── ESPAGNE ─────────────────────────────────────────────
  { name: "Ibiza", country: "Espagne", flag: "🇪🇸", tier: "exclusive" },
  { name: "Formentera", country: "Espagne", flag: "🇪🇸", tier: "exclusive" },
  { name: "Mallorca", country: "Espagne", flag: "🇪🇸", tier: "premium" },
  { name: "Marbella", country: "Espagne", flag: "🇪🇸", tier: "premium" },
  { name: "Puerto Banús", country: "Espagne", flag: "🇪🇸", tier: "exclusive" },
  { name: "Sotogrande", country: "Espagne", flag: "🇪🇸", tier: "exclusive" },
  { name: "Barcelone", country: "Espagne", flag: "🇪🇸", tier: "premium" },
  { name: "Sitges", country: "Espagne", flag: "🇪🇸", tier: "standard" },
  { name: "Costa Brava", country: "Espagne", flag: "🇪🇸", tier: "premium" },
  { name: "Minorque", country: "Espagne", flag: "🇪🇸", tier: "premium" },
  { name: "Valence", country: "Espagne", flag: "🇪🇸", tier: "standard" },

  // ── GRÈCE ───────────────────────────────────────────────
  { name: "Mykonos", country: "Grèce", flag: "🇬🇷", tier: "exclusive" },
  { name: "Santorin", country: "Grèce", flag: "🇬🇷", tier: "exclusive" },
  { name: "Corfou", country: "Grèce", flag: "🇬🇷", tier: "premium" },
  { name: "Rhodes", country: "Grèce", flag: "🇬🇷", tier: "premium" },
  { name: "Crète", country: "Grèce", flag: "🇬🇷", tier: "premium" },
  { name: "Paros", country: "Grèce", flag: "🇬🇷", tier: "premium" },
  { name: "Zakynthos", country: "Grèce", flag: "🇬🇷", tier: "standard" },
  { name: "Kefalonie", country: "Grèce", flag: "🇬🇷", tier: "standard" },
  { name: "Hydra", country: "Grèce", flag: "🇬🇷", tier: "premium" },
  { name: "Spetses", country: "Grèce", flag: "🇬🇷", tier: "premium" },
  { name: "Athènes", country: "Grèce", flag: "🇬🇷", tier: "standard" },

  // ── ITALIE ──────────────────────────────────────────────
  { name: "Porto Cervo", country: "Italie", flag: "🇮🇹", tier: "exclusive" },
  { name: "Portisco", country: "Italie", flag: "🇮🇹", tier: "exclusive" },
  { name: "Sardaigne", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Portofino", country: "Italie", flag: "🇮🇹", tier: "exclusive" },
  { name: "Santa Margherita", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Rapallo", country: "Italie", flag: "🇮🇹", tier: "standard" },
  { name: "Capri", country: "Italie", flag: "🇮🇹", tier: "exclusive" },
  { name: "Amalfi", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Positano", country: "Italie", flag: "🇮🇹", tier: "exclusive" },
  { name: "Ravello", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Taormine", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Sicile", country: "Italie", flag: "🇮🇹", tier: "standard" },
  { name: "Toscane", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Florence", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Venise", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Lac de Côme", country: "Italie", flag: "🇮🇹", tier: "exclusive" },
  { name: "Lac de Garde", country: "Italie", flag: "🇮🇹", tier: "premium" },
  { name: "Rome", country: "Italie", flag: "🇮🇹", tier: "premium" },

  // ── PORTUGAL ────────────────────────────────────────────
  { name: "Quinta do Lago", country: "Portugal", flag: "🇵🇹", tier: "exclusive" },
  { name: "Vale do Lobo", country: "Portugal", flag: "🇵🇹", tier: "exclusive" },
  { name: "Vilamoura", country: "Portugal", flag: "🇵🇹", tier: "premium" },
  { name: "Algarve", country: "Portugal", flag: "🇵🇹", tier: "premium" },
  { name: "Cascais", country: "Portugal", flag: "🇵🇹", tier: "premium" },
  { name: "Sintra", country: "Portugal", flag: "🇵🇹", tier: "premium" },
  { name: "Lisbonne", country: "Portugal", flag: "🇵🇹", tier: "standard" },
  { name: "Porto", country: "Portugal", flag: "🇵🇹", tier: "standard" },
  { name: "Comporta", country: "Portugal", flag: "🇵🇹", tier: "exclusive" },
  { name: "Melides", country: "Portugal", flag: "🇵🇹", tier: "premium" },

  // ── MAROC ───────────────────────────────────────────────
  { name: "Marrakech", country: "Maroc", flag: "🇲🇦", tier: "premium" },
  { name: "Essaouira", country: "Maroc", flag: "🇲🇦", tier: "standard" },
  { name: "Agadir", country: "Maroc", flag: "🇲🇦", tier: "standard" },
  { name: "Taroudant", country: "Maroc", flag: "🇲🇦", tier: "standard" },

  // ── ÉMIRATS & MOYEN-ORIENT ──────────────────────────────
  { name: "Dubaï", country: "Émirats", flag: "🇦🇪", tier: "exclusive" },
  { name: "Abu Dhabi", country: "Émirats", flag: "🇦🇪", tier: "exclusive" },

  // ── CROATIE & MÉDITERRANÉE EST ──────────────────────────
  { name: "Dubrovnik", country: "Croatie", flag: "🇭🇷", tier: "exclusive" },
  { name: "Hvar", country: "Croatie", flag: "🇭🇷", tier: "exclusive" },
  { name: "Split", country: "Croatie", flag: "🇭🇷", tier: "premium" },
  { name: "Korčula", country: "Croatie", flag: "🇭🇷", tier: "premium" },
  { name: "Brač", country: "Croatie", flag: "🇭🇷", tier: "standard" },

  // ── ROYAUME-UNI ─────────────────────────────────────────
  { name: "Londres", country: "Royaume-Uni", flag: "🇬🇧", tier: "premium" },
  { name: "Cotswolds", country: "Royaume-Uni", flag: "🇬🇧", tier: "premium" },
  { name: "Cornwall", country: "Royaume-Uni", flag: "🇬🇧", tier: "standard" },

  // ── AUTRES ──────────────────────────────────────────────
  { name: "Genève", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Montreux", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Crans-Montana", country: "Suisse", flag: "🇨🇭", tier: "exclusive" },
  { name: "Marbella", country: "Espagne", flag: "🇪🇸", tier: "premium" },
  { name: "Canaries", country: "Espagne", flag: "🇪🇸", tier: "standard" },
  { name: "Lanzarote", country: "Espagne", flag: "🇪🇸", tier: "standard" },
];
