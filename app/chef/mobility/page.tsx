...
export default function ChefCoveragePage() {
        ...
        <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 border border-stone-200">
           ...
           <div className="space-y-2">
              ...
              <Input 
                ...
                onChange={e => setData({...data, travelRadiusKm: parseInt(e.target.value)})} 
                placeholder="50" 
              />
           </div>
           ...
           <div className="space-y-4 pt-4 border-t border-stone-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                 {[
                   ...
                   <label key={zone} className={`flex items-center justify-between p-4 border cursor-pointer transition-colors ${data.coverageZones.includes(zone) ? 'border-stone-900 bg-stone-50' : 'border-stone-200 hover:border-stone-300'}`}>
                      ...
                      />
                      <div className={`w-4 h-4 border flex items-center justify-center ${data.coverageZones.includes(zone) ? 'bg-stone-900 border-stone-900' : 'border-stone-300'}`}>
           ...
           <label className="flex items-center gap-4 p-6 bg-stone-50 border border-stone-100 cursor-pointer">
              <div className={`w-5 h-5 border flex items-center justify-center ${data.internationalMobility ? 'bg-stone-900 border-stone-900' : 'border-stone-300'}`}>
