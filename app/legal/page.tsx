          ...
          <div id="mentions-legales" className="space-y-12 mb-24 scroll-mt-32">
            ...
            <div className="space-y-8 text-stone-600 font-light leading-relaxed">
              <div className="space-y-3">
                ...
                <p>
                  <strong>Chefs Talents</strong>
                  <br />
                  Forme juridique : <em>SASU</em>
                  <br />
                  Capital social : <em>1000.00€</em>
                  <br />
                  SIRET : <em>89832072600026</em>
                  <br />
                  RCS : <em>Bordeaux</em>
                  <br />
                  TVA intracommunautaire : <em>FR35898320726</em>
                  <br />
              ...
              <div className="space-y-3">
                ...
                <p>
                  La gestion des bases de données et de l’authentification est assurée par <strong>Supabase</strong>,
                  service technique tiers.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p>
                  Chefs Talents est une plateforme de mise en relation entre des chefs indépendants et des clients privés
                  ou professionnels (conciergeries, gestionnaires de biens, sociétés), dans le cadre de prestations
                  culinaires privées.
                </p>
                <p>
                  Chefs Talents agit exclusivement en tant qu’intermédiaire et n’intervient pas comme prestataire culinaire.
                  Les chefs référencés sont des professionnels indépendants.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p>
                  L’ensemble des éléments composant le site Chef Talents (textes, visuels, logo, marque, structure, design)
              ...
              <div className="space-y-3">
                ...
                <p>
                  Chefs Talents agit exclusivement en tant qu’intermédiaire. Sa responsabilité ne saurait être engagée au
                  titre des prestations réalisées par les chefs indépendants ni des litiges pouvant survenir entre les parties.
                </p>
              </div>
            </div>
          </div>
          ...
          <div id="confidentialite" className="space-y-12 mb-24 scroll-mt-32">
            ...
            <div className="space-y-8 text-stone-600 font-light leading-relaxed">
              <div className="space-y-3">
                ...
                <p>
                  Les données personnelles collectées sur le site Chefs Talents sont traitées par Chefs Talents.
                  <br />
                  Contact :{' '}
              ...
              <div className="space-y-3">
                ...
                <p>
                  Les traitements sont fondés sur l’exécution d’un contrat ou de mesures précontractuelles, l’intérêt légitime de
                  Chefs Talents, et le consentement de l’utilisateur lorsque requis.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p>
                  Les données peuvent être transmises uniquement aux prestataires techniques nécessaires au fonctionnement du service,
                  notamment :
                </p>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <div className="space-y-3">
                ...
                <p>
                  Les données sont conservées pendant la durée de la relation contractuelle, puis archivées conformément aux obligations
                  légales, ou supprimées sur demande de l’utilisateur.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p>
                  Chefs Talents met en œuvre des mesures techniques et organisationnelles appropriées afin de garantir la sécurité et la
              ...
              <div className="space-y-3">
                ...
                <p>
                  Conformément au RGPD, chaque utilisateur dispose d’un droit d’accès, de rectification, de suppression, d’opposition
              ...
              <div className="space-y-3">
                ...
                <p>
                  Le site Chefs Talents n’utilise que des cookies strictement nécessaires à son bon fonctionnement.
                  Aucun cookie publicitaire n’est déployé sans consentement explicite.
                </p>
                <p className="text-sm text-stone-500">
                  (Cette section pourra être mise à jour en cas d’intégration d’outils d’analyse.)
                </p>
              </div>
            </div>
          </div>
