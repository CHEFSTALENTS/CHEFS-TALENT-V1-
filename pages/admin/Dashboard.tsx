        ...
        <div className="bg-orange-50 border border-orange-100 p-6 flex flex-col gap-4">
           ...
           <div className="flex flex-wrap gap-4">
              {unassignedRequests.length > 0 && (
                 <Link to="/admin/requests" className="bg-white px-4 py-2 text-sm text-stone-600 border border-orange-200 hover:border-orange-400 flex items-center gap-2 transition-colors">
                    <span className="w-2 h-2 rounded-full bg-orange-500" />
                    {unassignedRequests.length} demande(s) non assignée(s)
                 </Link>
              )}
              {staleOffers.length > 0 && (
                 <Link to="/admin/missions" className="bg-white px-4 py-2 text-sm text-stone-600 border border-orange-200 hover:border-orange-400 flex items-center gap-2 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
         ...
         <div className="bg-white border border-stone-200 p-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link to="/admin/requests" className="text-xs uppercase tracking-widest text-stone-400 hover:text-stone-900">Voir tout</Link>
            </div>
