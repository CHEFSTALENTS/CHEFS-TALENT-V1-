...
const fr: Dictionary = {
  ...
  dashboard: {
    ...
    vipPriceLabel: 'Chef VIP — à partir de 40€/mois',
    vipTitle: 'Passez en tête de liste',
    vipBenefits: [
      'Profil boosté · Priorité sur les missions',
      'Groupe privé Last Minute · Tips & e-books',
      'Call de positionnement (engagement 12 mois)',
    ],
    vipCta: 'Découvrir les plans VIP',
    vipRedirecting: 'Redirection…',
    boostActiveLabel: 'Boost actif · {days}j restants',
    boostInactiveLabel: 'Boost de profil — 119€/mois',
...
const es: Dictionary = {
  ...
  dashboard: {
    ...
    vipPriceLabel: 'Chef VIP — desde 40€/mes',
    vipTitle: 'Pase al primer puesto',
    vipBenefits: [
      'Perfil potenciado · Prioridad en misiones',
      'Grupo privado Last Minute · Tips y e-books',
      'Llamada de posicionamiento (compromiso 12 meses)',
    ],
    vipCta: 'Descubrir los planes VIP',
    vipRedirecting: 'Redirigiendo…',
    boostActiveLabel: 'Boost activo · {days}d restantes',
    boostInactiveLabel: 'Boost de perfil — 119€/mes',
